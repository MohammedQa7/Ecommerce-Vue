...
<div role="status" class="max-w-sm border border-gray-300 rounded-lg p-4">
    <div
      class="animate-pulse w-full bg-gray-300 h-48 rounded-lg mb-5 flex justify-center items-center"
    >
      <svg
    ...
    <div class="w-full flex justify-between items-start animate-pulse flex-col">
